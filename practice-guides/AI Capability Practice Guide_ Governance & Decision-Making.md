...
## **Stage 1 — Orientation & Fast Start (Governance & Decision-Making)**
...
> *“This decision concerns: \[specific decision being taken\].”*
...
### **Step 2 — Identify AI Influence (Not Just Use)**
...
### **Step 3 — Apply the Decision Risk Screen**
...
### **Step 4 — Set the Governance Level**

Choose one:

✅ **Proceed with documented oversight  **
🔁 **Request clarification, evidence, or alternatives  **
⛔ **Pause or escalate** (ethics, legal, board, regulator)

Record the rationale briefly.

**  **

### **Step 5 — Create a Minimal Decision Record**
...
If it isn’t recorded, it effectively didn’t happen.
...
Write a **Decision Accountability Note** (3–5 lines):
...
- **AI Awareness & Orientation** — Knowing what AI influence actually means

- **Human–AI Co-Agency** — Making authority and responsibility explicit

- **Applied Practice & Innovation** — Allowing use without bypassing oversight

- **Ethics, Equity & Impact** — Anticipating harm and unfairness

- **Decision-Making & Governance** — Ensuring traceability and escalation

- **Reflection, Learning & Renewal** — Improving governance over time

Skipping domains doesn’t speed decisions.  
It transfers risk to those least able to contest it.

## **Stage 2 — How This Guide Works & Situational Entry Points (Governance & Decision-Making)**
...
## **Entry Point 1 — “This recommendation is persuasive, but opaque.”**
...
## **Entry Point 2 — “This decision affects people who cannot contest it.”**
...
## **Entry Point 3 — “AI is shaping judgement, not just informing it.”**
...
## **Entry Point 4 — “If challenged, we need to justify this decision.”**
...
- Document AI’s role and human reasoning
...
## **Entry Point 5 — “AI use is becoming routine across decisions.”**
...
## **Entry Point 6 — “I want governance that enables, not blocks, good decisions.”**
...
## **Stage 3 — Core Practice Workflow: Domains 1–3 (Governance & Decision-Making)**

*Ensuring Decisions Influenced by AI Remain Accountable, Transparent, and Legitimate*

Domains 1–3 determine whether AI is used **within** governance — or quietly bypasses it.
...
# **DOMAIN 1 — AI Awareness & Orientation (Decision Transparency)**

## **What This Domain Protects**

This domain protects governance from:

- treating AI influence as neutral or “just technical”
...
## **Tool in Use — AI Influence Statement**
...
## **Tool in Use — Decision Authority Map**
...
- attributing outcomes to “the model”
...
# **DOMAIN 3 — Applied Practice & Innovation (Governed Use Without Paralysis)**
...
## **Tool in Use — Governance Tiering Model**
...
**Does our governance fit the risk—or has it drifted?**

# **Domains 1–3 in Practice (Governance & Decision-Making)**

Together, Domains 1–3 ensure that:
...
As impact and scrutiny increase, these domains must be complemented by Domains 4–6:
...
## **Stage 4 — Risk, Responsibility & Renewal: Domains 4–6 (Governance & Decision-Making)**

*Ensuring Fairness, Legitimacy, and Long-Term Accountability in AI-Influenced Decisions*

Domains 4–6 address the **hardest problems in governance**:  
...
# **DOMAIN 4 — Ethics, Equity & Impact (Fairness and Contestability)**
...
## **Tool in Use — Governance Equity & Impact Scan**
...
- dismissing equity concerns as “subjective”
...
# **DOMAIN 5 — Decision-Making & Governance (Defensibility Under Scrutiny)**
...
AI adds complexity — governance must add clarity.
...
## **Tool in Use — Decision Defensibility Record**
...
**Could this decision be defended clearly in six months’ time?**

# **DOMAIN 6 — Reflection, Learning & Renewal (Institutional Capability)**
...
## **Tool in Use — Governance Learning Loop**

Adopt this cycle:

**Review → Adjust → Reinforce**
...
# **Domains 4–6 in Practice (Governance & Decision-Making)**

Together, Domains 4–6 ensure that:
...
**Awareness → Co-Agency → Practice → Ethics → Governance → Reflection → Renewal**

Skipping steps hides risk.  
Revisiting steps builds institutional trust.

## **Stage 5 — Capability Self-Check, Worked Governance Scenario & Operating Model**
...
## **PART A — GOVERNANCE AI CAPABILITY SELF-CHECK**

This self-check answers one question:

> **“Where does our governance need to tighten or adapt for AI-influenced decisions?”**
...
- Gaps in **Domains 1–2** → clarify AI influence and accountability immediately

- Gaps in **Domains 4–5** → raise governance scrutiny before scaling

- Gaps in **Domain 6** → expect repeated issues

Strong governance is **iterative, not static**.

## **PART B — WORKED GOVERNANCE SCENARIO (END-TO-END)**
...
No one can say, “The system decided.”
...
Innovation exists—but within guardrails.
...
### **4️⃣ Documentation & Escalation Triggers**
...
### **5️⃣ Governance Review Rhythm**

We review AI-related decisions:  
☐ after each major decision ☐ quarterly ☐ annually
