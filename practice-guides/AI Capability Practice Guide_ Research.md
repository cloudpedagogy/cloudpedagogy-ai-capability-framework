...
This guide is for people engaged in **research and knowledge production** who are already using—or are about to use—AI and want to do so:
...
This guide assumes **you remain fully responsible** for claims, methods, and interpretations—even when AI is involved.
...
- reflect on AI’s effect on your thinking and improve future practice
...
- something “feels off”, but you can’t quite articulate the risk
...
### **Step 1 — Name the Research Task**

Write down, in plain language:

> *“I am using AI to help me with: \[specific research task\].”*
...
Avoid vague phrasing like *“help with my research”*.

### **Step 2 — Decide the Role of AI (Co-Agency Check)**
...
### **Step 4 — Run the Rapid Integrity Screen**
...
If the answer is “no” or “unsure”, slow down and increase verification.

### **Step 5 — Decide the Action**

Choose one:

✅ **Proceed with AI support** (with verification)  
🔁 **Revise the task or prompt  **
⛔ **Pause and escalate** (consult supervisor, ethics lead, or methods expert)
...
> “Which AI capability domain should I apply?”
...
## **Entry Point 1 — “I need to move quickly, but I’m uneasy.”**
...
AI could help—but something feels risky.
...
- Treating “draft” outputs as conceptually safe

## **Entry Point 2 — “I’m not sure AI is appropriate here.”**

You could use AI—but may be crossing a boundary:
...
## **Entry Point 3 — “The output looks good, but I don’t fully trust it.”**

The AI output is fluent, coherent, and persuasive—  
...
## **Entry Point 4 — “This affects people beyond me.”**
...
Domains 1–3 help you use AI **without compromising epistemic integrity**, research methods, or authorship.  
These domains shape *how* you think with AI—not what AI produces.
...
## **Tool in Use — Research Awareness Check**
...
- assuming AI “knows” niche or emergent fields

- accepting summaries without tracing claims to sources

- overlooking hallucinated citations that “look right”
...
- delegating interpretation of findings (“What does this result mean?”)
...
**Did I design the research–AI relationship intentionally, or did I let it emerge by default?**

One sentence is enough.

# **DOMAIN 3 — Applied Practice & Innovation (Safe Research Experimentation)**
...
> *“Generate alternative framings or conceptual groupings for this topic.  
> Do not produce citations or claim accuracy.  
> I will review for validity, evidence, and alignment with accepted literature.”*
...
- allowing AI’s fluency to override uncertainty or nuance

- collapsing conceptual categories based on AI’s convenience

- using AI to “decide” what interpretations are strongest
...
Together, Domains 1–3 establish a research environment where:
...
They prepare the foundation for Domains 4–6, which address:
...
Domains 4–6 come into play whenever research outputs:
...
- avoidance of harm—material, reputational, or interpretive
...
- which explanations appear “normal”
...
## **Tool in Use — Ethical Impact Scan (Research)**
...
- trusting AI’s “neutral” tone as objective
...
## **Tool in Use — Research Decision Transparency Log**
...
- assuming “everyone uses AI” means governance is optional
...
Without reflection, capability **decays** even as tools “improve.”
...
## **Tool in Use — Mini Reflection Cycle (Research)**
...
Capture one sentence—this is your renewal boundary.

# **Domains 4–6 in Practice (Research)**
...
## **Stage 5 — Capability Self-Check, Worked Research Scenario & Operating Model**
...
## **PART A — RESEARCH AI CAPABILITY SELF-CHECK**

This is **not** an assessment and **not** a scorecard.  
Its purpose is to answer one question:

> **“Where do I need to focus next to use AI safely and well in research?”**
...
- Gaps in **Domains 1–2** → slow down and rebuild foundations

- Gaps in **Domains 4–5** → increase oversight before scaling

- Gaps in **Domain 6** → capability will stagnate
...
- avoid asking for “final reviews”
...
### **1️⃣ My Valid Reasons to Use AI in Research**
...
> *I use AI to support—not substitute—scholarship.  
